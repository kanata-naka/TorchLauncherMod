  ...
  public static void registerItemProperties(FMLClientSetupEvent event) {
    ItemProperties.register(TORCH_LAUNCHER.get(), ResourceLocation.withDefaultNamespace("pulling"),
        (itemStack, level, livingEntity,
            seed) -> livingEntity != null && livingEntity.isUsingItem() && livingEntity.getUseItem() == itemStack ? 1.0F
                : 0.0F);
    ItemProperties.register(TORCH_LAUNCHER.get(), ResourceLocation.withDefaultNamespace("pull"),
