...
public class TorchLauncherModEntities {
  ...
  public static final Supplier<EntityType<TorchLauncherProjectileEntity>> TORCH_LAUNCHER_PROJECTILE_ENTITY = ENTITIES.register("torch_launcher_projectile_entity",
      () -> EntityType.Builder.<TorchLauncherProjectileEntity>of(TorchLauncherProjectileEntity::new, MobCategory.MISC).sized(1.0F, 1.0F).eyeHeight(0.5F).clientTrackingRange(4)
          .updateInterval(20).build(ResourceKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(TorchLauncherMod.MODID, "torch_launcher_projectile_entity"))));
