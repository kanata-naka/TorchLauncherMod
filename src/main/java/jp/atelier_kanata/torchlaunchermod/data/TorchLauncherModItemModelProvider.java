...
public class TorchLauncherModItemModelProvider extends ItemModelProvider {
  ...
  protected void registerModels() {
    ResourceLocation torchLauncherResourceLocation = TorchLauncherModItems.TORCH_LAUNCHER.getId();
    ItemModelBuilder torchLauncherModelBuilder = singleTexture(torchLauncherResourceLocation.getPath(), mcLoc(folder + "/generated"), "layer0",
        ResourceLocation.fromNamespaceAndPath(torchLauncherResourceLocation.getNamespace(), folder + "/" + torchLauncherResourceLocation.getPath())).transforms()
            //
    ...
    ModelFile torchLauncherModelPulling0 = singleTexture(torchLauncherResourceLocation.getPath() + "_pulling_0", mcLoc(folder + "/generated"), "layer0",
        ResourceLocation.fromNamespaceAndPath(torchLauncherResourceLocation.getNamespace(), folder + "/" + torchLauncherResourceLocation.getPath() + "_pulling_0"))
            .parent(torchLauncherModelBuilder);

    ModelFile torchLauncherModelPulling1 = singleTexture(torchLauncherResourceLocation.getPath() + "_pulling_1", mcLoc(folder + "/generated"), "layer0",
        ResourceLocation.fromNamespaceAndPath(torchLauncherResourceLocation.getNamespace(), folder + "/" + torchLauncherResourceLocation.getPath() + "_pulling_1"))
            .parent(torchLauncherModelBuilder);

    ModelFile torchLauncherModelPulling2 = singleTexture(torchLauncherResourceLocation.getPath() + "_pulling_2", mcLoc(folder + "/generated"), "layer0",
        ResourceLocation.fromNamespaceAndPath(torchLauncherResourceLocation.getNamespace(), folder + "/" + torchLauncherResourceLocation.getPath() + "_pulling_2"))
            .parent(torchLauncherModelBuilder);
